              ...
              <div class="media align-items-center">
                ...
                ?>
                  ...
                  <div class="media-body ml-2 d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">@<?php echo htmlentities($_SESSION['acclogin']); ?></span>
                  </div>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-header noti-title">
                <h6 class="text-overflow m-0" title="Nama Anda"><?php echo htmlentities($row['nama_acc']); ?></h6>
              </div>
            <?php } ?>
            <?php
