    ...
    if (isset($_POST["import"])) {
        ...
        if ($_FILES["file"]["size"] > 0) {
            ...
            while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
                ...
                $kd_fakultas = "";
                if (isset($column[3])) {
                    $kd_fakultas = mysqli_real_escape_string($conn, $column[3]);
                }
                $kd_prodi = "";
                if (isset($column[4])) {
                    $kd_prodi = mysqli_real_escape_string($conn, $column[4]);
                }
                $id_dosen_wali = "";
                if (isset($column[5])) {
...
?>
    ...
    <div class="main-content" id="panel">
        ...
        ?>
        <!-- Header -->
        <!-- INSERT into user_mhs (username,nama_mhs,password,kd_fakultas,kd_prodi,id_dosen_wali,kd_role)
