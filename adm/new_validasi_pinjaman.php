                        ...
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="text-sm">
                                        *<strong>P1</strong> = Poin Gaji Orangtua | <strong>P2</strong> = IPK Mahasiswa | <strong>P3</strong> = Poin Semester | <strong>P4</strong> = Poin Nominal | <strong>P5</strong> = Poin Banyak Pengajuan Pinjaman Diterima
                                    </p>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['poin_nominal']); ?></td>
                                            <td><?php echo htmlentities($row['poin_total_diterima']); ?></td>
                                            <td><b><?php $total = $row['poin_gaji_ortu'] + $row['poin_ipk'] + $row['poin_semester'] + $row['poin_nominal'] + $row['poin_total_diterima'];
                                                    echo $total; ?></b></td>
