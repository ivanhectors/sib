...
(1, 'F-B3-01', 'Beasiswa Kebutuhan UKDW', 'Ditawarkan kepada mahasiswa minimal telah duduk di semester II yang mengalami kesulitan finansial.', '2020-07-01', '2020-07-13', '2020-07-16 13:47:11', 1),
...
(9, 'test', '$2y$10$IVYmHAVUH9aHzvOK1IxwyOKFRKaR9mqJf4F8EYQ.AB6tOxVpBPm0q', 's', 'Pria', '0000-00-00', '', 'ivansnbl@gmail.com', '', '', '082388888888', '99', '99', '4', 1, '2020-07-26 01:38:54', '2020-08-08 22:03:21');
...
CREATE TABLE `user_mhs` (
  ...
  `kd_fakultas` char(2) DEFAULT NULL,
  `kd_prodi` char(2) DEFAULT NULL,
  `id_dosen_wali` int(3) DEFAULT NULL,
  `kd_role` char(1) DEFAULT NULL,
  `status` int(1) NOT NULL DEFAULT 1,
  `createDate` datetime NOT NULL DEFAULT current_timestamp(),
...
(1, '72160057', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Ivan Hector Sinambela', 'Pria', '1998-11-23', '', 'ivan.hector@si.ukdw.ac.id', 'Jl. Dr. Wahidin No.45 Yogyakarta', '55555', '082386949999', '7', '72', 2, '5', 1, '2020-07-05 00:19:17', '2020-08-13 14:09:19'),
...
(39, '61170004', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Janet', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '6', '61', 2, '5', 1, '2020-08-14 00:47:59', '2020-08-13 17:47:59'),
...
(113, '72170060', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Timotius', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '7', '72', 2, '5', 1, '2020-08-14 01:07:23', '2020-08-13 18:07:23'),
...
(117, '72170060', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Timotius', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '7', '72', 2, '5', 1, '2020-08-14 01:12:51', '2020-08-13 18:12:51'),
...
--
ALTER TABLE `userlog`
  MODIFY `iduserlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `user_mhs`
  MODIFY `id_mhs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `syarat_bsw`
  ADD CONSTRAINT `syarat_bsw_ibfk_1` FOREIGN KEY (`kd_syarat`) REFERENCES `ref_syarat` (`kd_syarat`) ON DELETE NO ACTION ON UPDATE NO ACTION,
