...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2020 at 04:40 AM
...
INSERT INTO `pembayaran` (`kd_bayar`, `kd_daftar`, `tgl_bayar`, `nominal_bayar`, `semester`, `bukti_bayar`, `sts_bayar`) VALUES
(3, '7216005720201428', '2020-09-14 12:33:09', 10970000, '', '', 'Dibayar');
...
INSERT INTO `pendaftaran` (`kd_daftar`, `nim`, `kd_bsw`, `no_telp_ortu`, `ipk`, `pekerjaan_ortu`, `tgl_daftar`, `thn_ajaran`, `semester`, `tahun`, `nominal_pengajuan`, `nominal_disetujui`, `status`, `tgl_update`) VALUES
('7216005720201412', '72160057', 1, '082399999999', '3.34', 'Petani', '2019-02-07 15:01:09', '2019/2020', 'Genap', '20192', 9970000, 2000000, 'diterima', '2020-09-14 13:27:21'),
('7216005720201428', '72160057', 2, '82399999999', '3.34', 'Petani', '2020-08-27 15:01:09', '2020/2021', 'Gasal', '20201', 10970000, 10970000, 'diterima', '2020-09-13 16:27:34'),
('7216005720201429', '72160057', 1, '082399999999', '3.34', 'Petani', '2019-08-15 15:01:09', '2019/2020', 'Gasal', '20191', 7970000, 7970000, NULL, '2020-09-13 15:47:19'),
('7216005720201435', '72160057', 2, '082399999999', '3.34', 'Petani', '2019-08-15 15:01:09', '2019/2020', 'Gasal', '20191', 9970000, 9970000, NULL, '2020-09-13 15:47:19');
...
INSERT INTO `ref_fakultas` (`id_fakultas`, `kd_fakultas`, `nama_fakultas`) VALUES
(1, '7', 'Teknologi Informasi'),
(2, '2', 'Teologi'),
(3, '1', 'Bisnis'),
(4, '3', 'Biologi'),
(5, '4', 'Kedokteran'),
(6, '6', 'Arsitektur dan Desain'),
(7, '8', 'Kependidikan dan Humaniora'),
(8, '99', 'Lainnya'),
(17, '77', 'Perfiliman dan Biografi');
...
INSERT INTO `ref_prodi` (`id_prodi`, `kd_prodi`, `kd_fakultas`, `nama_prodi`) VALUES
(1, '71', '7', 'Informatika'),
(2, '72', '7', 'Sistem Informasi'),
(3, '13', '2', 'Teologi'),
(4, '11', '1', 'Manajemen'),
(5, '12', '1', 'Akuntansi'),
(6, '61', '6', 'Arsitektur'),
(7, '62', '6', 'Desain Produk'),
(8, '31', '3', 'Biologi'),
(9, '41', '4', 'Kedokteran'),
(10, '99', '99', 'Lainnya'),
(13, '81', '8', 'Bahasa Inggris');
...
INSERT INTO `ref_role` (`id_role`, `kd_role`, `nama_role`) VALUES
(1, '1', 'Administrator'),
(2, '2', 'Wakil Rektor III'),
(3, '3', 'Wakil Dekan III Fakultas'),
(4, '4', 'Dosen Wali'),
(5, '5', 'Mahasiswa');
...
CREATE TABLE `sts_daftar` (
  ...
  `kd_daftar` varchar(16) DEFAULT NULL,
...
INSERT INTO `sts_daftar` (`kd_sts_daftar`, `kd_daftar`, `acc_role`, `acc_username`, `acc_tanggal`, `status`) VALUES
(2, '7216005720201428', '2', 'joko', '2020-08-31 02:00:47', 'diterima'),
(3, '7216005720201412', '4', 'argo', '2020-09-11 21:29:28', 'acc-dosen-wali'),
(4, '7216005720201428', '4', 'argo', '2020-08-31 02:00:47', 'diterima'),
(5, '7216005720201428', '3', 'willy', '2020-08-31 02:00:47', 'diterima');
...
(94, '7216005720201412', 47, '72160057_Invoice Registrasi_2020_Ganjil_1598540469.pdf'),
(95, '7216005720201412', 48, '72160057_Bukti Pembayaran Listrik Bulan Terakhir_2020_Ganjil_1598540469.pdf'),
(96, '7216005720201435', 47, '72160057_Invoice Registrasi_2020_Ganjil_1598540469.pdf');
...
CREATE TABLE `user_acc` (
  ...
  `kd_prodi` char(2) DEFAULT NULL,
  `kd_role` char(1) DEFAULT NULL,
...
INSERT INTO `user_acc` (`id_acc`, `username`, `password`, `nama_acc`, `gender`, `tgl_lahir`, `photo_acc`, `email`, `alamat`, `provinsi`, `kab_kota`, `kecamatan`, `kode_pos`, `no_telp`, `kd_fakultas`, `kd_prodi`, `kd_role`, `status`, `createDate`, `updateDate`) VALUES
...
(9, 'testingacc', '$2y$10$IVYmHAVUH9aHzvOK1IxwyOKFRKaR9mqJf4F8EYQ.AB6tOxVpBPm0q', 'Testing Penyeleksi', 'Pria', '0000-00-00', '', 'ivansnbl@gmail.com', '', NULL, NULL, NULL, '', '082388888888', '99', '99', '4', 1, '2020-07-26 01:38:54', '2020-08-21 02:03:44'),
...
(22, 'ivan', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Ivan Hector Sinambela', NULL, NULL, NULL, 'ivan.hector@si.ukdw.ac.id', NULL, NULL, NULL, NULL, NULL, '082388888888', '1', 1, '2020-07-06 00:20:31', '2020-08-21 02:11:00'),
...
INSERT INTO `user_mhs` (`id_mhs`, `username`, `password`, `nama_mhs`, `gender`, `tgl_lahir`, `photo_mhs`, `email`, `alamat`, `provinsi`, `kab_kota`, `kecamatan`, `kode_pos`, `no_telp`, `kd_fakultas`, `kd_prodi`, `id_dosen_wali`, `kd_role`, `status`, `createDate`, `updateDate`) VALUES
...
(36, '31170031', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Kevin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', '31', 2, '5', 1, '2020-08-14 00:47:59', '2020-08-13 17:47:59'),
(37, '71170123', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Vincy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '7', '71', 2, '5', 1, '2020-08-14 00:47:59', '2020-08-13 17:47:59'),
(39, '61170009', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Janet', NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', '6', '61', NULL, '5', 1, '2020-08-14 00:47:59', '2020-08-19 06:34:19'),
(111, '31170032', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Kevin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', '31', 2, '5', 1, '2020-08-14 01:07:23', '2020-08-13 18:07:23'),
(115, '31170032', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Kevin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', '31', 2, '5', 1, '2020-08-14 01:12:51', '2020-08-13 18:12:51'),
(118, '61170005', '$2y$10$45c9JSZ.tEiOmaQD8b3KQeIklOOYJiV/ckWEiO3HG4vQuwH8/GK3G', 'Janet', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '6', '61', 2, '5', 1, '2020-08-14 01:12:51', '2020-08-13 18:12:51'),
(122, '72160058', '$2y$10$PkPf7.fs.q2fxf5Wg9i5w.DYmhS1qixUeAiMWUW0eaxhlGP4gyMry', 'Ica Yenni', NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', '7', '72', 2, '5', 1, '2020-08-19 14:43:21', '2020-08-19 07:43:21');
...
ALTER TABLE `user_mhs`
  ...
  ADD KEY `role` (`kd_role`),
  ADD KEY `kd_prodi` (`kd_prodi`) USING BTREE,
...
--
ALTER TABLE `ref_role`
  MODIFY `id_role` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `userlog`
  MODIFY `iduserlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `user_mhs`
  MODIFY `id_mhs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
ALTER TABLE `pendaftaran`
  ...
  ADD CONSTRAINT `pendaftaran_ibfk_2` FOREIGN KEY (`nim`) REFERENCES `user_mhs` (`username`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `ref_prodi`
--
ALTER TABLE `ref_prodi`
  ADD CONSTRAINT `ref_prodi_ibfk_1` FOREIGN KEY (`kd_fakultas`) REFERENCES `ref_fakultas` (`kd_fakultas`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `user_acc`
  ADD CONSTRAINT `user_acc_ibfk_2` FOREIGN KEY (`kd_fakultas`) REFERENCES `ref_fakultas` (`kd_fakultas`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `user_acc_ibfk_3` FOREIGN KEY (`kd_prodi`) REFERENCES `ref_prodi` (`kd_prodi`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `user_acc_ibfk_4` FOREIGN KEY (`kd_role`) REFERENCES `ref_role` (`kd_role`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `user_admin`
  ADD CONSTRAINT `user_admin_ibfk_2` FOREIGN KEY (`kd_role`) REFERENCES `ref_role` (`kd_role`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `user_mhs`
  ADD CONSTRAINT `user_mhs_ibfk_2` FOREIGN KEY (`kd_fakultas`) REFERENCES `ref_fakultas` (`kd_fakultas`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `user_mhs_ibfk_3` FOREIGN KEY (`kd_prodi`) REFERENCES `ref_prodi` (`kd_prodi`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `user_mhs_ibfk_4` FOREIGN KEY (`kd_role`) REFERENCES `ref_role` (`kd_role`) ON DELETE NO ACTION ON UPDATE CASCADE,
