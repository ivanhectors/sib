...
<!DOCTYPE html>
 ...
 <head>
   ...
   <title>SIB - Sistem Informasi Beasiswa Kebutuhan dan Pinjaman Registrasi UKDW</title>
   <!-- Favicon -->
 ...
 <body>
   ...
   <nav id="navbar-main" class="navbar navbar-horizontal navbar-main navbar-expand-lg navbar-dark bg-primary">
     <div class="container">
       <a class="navbar-brand" href="../sib/index">
       ...
       <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item d-none d-lg-block ml-lg-4">
             <a href="../sib/login" class="btn btn-neutral btn-icon">
